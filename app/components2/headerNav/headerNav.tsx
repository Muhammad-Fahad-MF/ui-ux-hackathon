...
export default function HeaderNav() {
  return (
    <div className="bg-[url('/images/headerNav/bgHeader.svg')] bg-cover aspect-[192/42] text-white font-Inter400 flex flex-col items-center gap-[108px]">
        <section className="w-full h-[90px] bg-[#0d0d0d] px-[300px] flex items-center justify-between" id="nav">
            ...
            <ul className="flex gap-4 items-center">
                ...
                <li><Link href="#"><Image src="/images/header-banner/Handbag.svg" alt="{-}" height={24} width={24}/></Link></li>
            </ul>
        </section>
        <section className="flex flex-col items-center gap-5">
            <h1 className="font-HelveticaBold text-[48px] leading-[56px]">Our Shop</h1>
            <div className="flex gap-1 ">
                <p className="text-[20px] leading-[28px]">Home</p>
                <Image src="/images/headerNav/CaretRight.svg" alt=" " width={16} height={16}/>
                <p className="text-[20px] leading-[28px] text-primary1">Shop</p>
            </div>
        </section>
