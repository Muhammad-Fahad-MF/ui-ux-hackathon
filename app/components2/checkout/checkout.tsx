...
export default function MainCheckout() {
  return (
    <div className="px-[300px] py-[120px] flex gap-6">
        <section className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4">
                    <span className="flex gap-6">
                        <div className="flex flex-col gap-2">
                            <h4>First name</h4>
                            <input className="box-border border-[1px] border-[#e0e0e0] w-[424px] h-[56px] focus:outline-none focus:border-black pl-[15px]" placeholder=" "/>
                        </div>
                        <div className="flex flex-col gap-2">
                            <h4>Last name</h4>
                            <input className="box-border border-[1px] border-[#e0e0e0] w-[424px] h-[56px] focus:outline-none focus:border-black pl-[15px]" placeholder=" "/>
                    ...
                    <span className="flex gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <h4>Country</h4>
                            <div className="box-border border-[1px] border-[#e0e0e0] w-[424px] h-[56px] active:border-black px-[15px] flex justify-between items-center text-[#828282]">
                                Choose country
            ...
            <div className="flex flex-col gap-1">
                ...
                <span className="flex gap-2 items-center py-[1px]">
                ...
                <span className="flex gap-6 mt-5">
                    <button className="w-[424px] h-[56px] box-border border-[1px] border-[#e0e0e0] flex justify-center items-center gap-2 text-[#4f4f4f]"><Image src="/images/check/CaretLeft.svg" alt="<" height={24} width={24}/>Back to cart</button>
                    <button className="w-[424px] h-[56px] bg-primary1 flex justify-center items-center gap-2 text-white active:opacity-90">Proceed to shipping<Image src="/images/check/CaretRight.svg" alt=">" height={24} width={24}/></button>
                </span>
            </div>
        </section>
        <section className="box-border border-[1px] border-[#e0e0e0] w-[424px] h-[700px] px-6 py-6">
