...
export default function FoodCard({discount, foodCat, imgSource}: foodCart) {
  return (
    <Link href="/shop">
     <div className="min-w-[305px] min-h-[328px] relative group parent rounded-md z-10" style={{backgroundImage:  `url('${imgSource}')`}}>
        <div className="flex flex-col gap-[11px] items-end absolute left-0 top-[123px] child opacity-0 group-hover:opacity-100">
