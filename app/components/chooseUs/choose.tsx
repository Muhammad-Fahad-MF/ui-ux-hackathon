...
export default function Choose() {
  return (
    <div className="py-[120px] px-[300px] bg-black/95 flex gap-[135px] text-white font-Inter400">
      ...
      <section className="flex flex-col ">
        <h3  className="font-GreatVibes text-[32px] leading-[40px] text-primary1">Why Choose us</h3>
        <h1 className="font-HelveticaBold text-[48px] leading-[56px] w-[433px] mt-2"><code className="font-HelveticaBold text-[48px] leading-[56px] text-primary1">Ex</code>ta ordinary taste And Experienced </h1>
        <p className="w-[526px] mt-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque diam pellentesque bibendum non dui volutpat fringilla bibendum. Urna, elit augue urna, vitae feugiat pretium donec id elementum. Ultrices mattis sed vitae mus risus. Lacus nisi, et ac dapibus sit eu velit in <br/>consequat.</p>
        <span className="flex gap-[33px] mt-8">
        ...
        <span className="bg-white rounded-md w-[374px] h-[93px] border-l-[10px] border-primary1 flex justify-evenly items-center mt-[34px]">
