...
export default function ReviewCard() {
  return (
    <div  style={{boxShadow: '0px 0px 80px 0px #CDCDCD40'}} className="bg-white w-[869px] h-[451px] mt-[123px] relative flex flex-col items-center self-center max-sm:w-full">
        <Image src="/images/reviews/Dp.svg" alt="_" height={134} width={133} className="absolute mx-auto -top-[67px] rounded-full "/>
        <Image src="/images/reviews/Quotes.svg" alt=",," height={48} width={48} className=" mt-[99px] max-sm:mt-[83px]"/>
        <p className="font-Helvetica text-[18px] leading-[26px] text-center text-[#4f4f4f] w-[696.57px] mt-8 max-sm:w-auto max-sm:mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque diam pellentesque bibendum non dui volutpat fringilla bibendum. Urna, elit augue urna, vitae feugiat pretium donec id elementum. Ultrices mattis sed vitae mus risus. Lacus nisi, et ac dapibus sit eu velit in consequat.</p>
        <ul className="flex gap-2 items-center mt-8 max-sm:mt-4">
