...
export default function Client() {
  return (
   <div className="bg-[url('/images/client/bgClient.svg')] w-full aspect-[641/156] bg-cover bg-center text-white font-Inter400">
    <div className="bg-[#0D0D0DD9]/85 h-full w-full flex items-center justify-center gap-[161px]">
