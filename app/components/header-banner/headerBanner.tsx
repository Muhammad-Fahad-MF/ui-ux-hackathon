...
export default function HeaderBanner() {
  return (
    <div className="bg-[url('/images/header-banner/bannerBg.svg')] w-full aspect-[192/95] bg-cover bg-center max-sm:aspect-auto max-sm:h-full max-lp:aspect-auto">
        <div className="bg-secondary1/95 h-full">
           <Navbar />
           <div className="ml-[242px] mt-[59px] flex max-sm:ml-4 max-sm:mt-7 max-sm:pb-5 max-lp:ml-8 max-lp:mt-10 max-lp:pb-5">
              ...
              <span className="ml-[45px] flex flex-col gap-2 mt-[102px] max-sm:mt-14 max-sm:ml-12 max-lp:mt-14">
