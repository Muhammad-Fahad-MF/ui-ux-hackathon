...
export default function Menu() {
  return (
  <div className="font-Inter400 text-white bg-black/95 px-[300px] flex flex-col items-center py-[120px] max-sm:px-0 max-sm:py-14 max-lp:px-0 max-lp:py-[60px]">
    <h3  className="font-GreatVibes text-[32px] leading-[40px] text-primary1 max-sm:text-2xl">Choose & pick</h3>
    <h1 className="font-HelveticaBold text-[48px] leading-[56px] mt-2 max-sm:text-4xl"><code className="font-HelveticaBold text-[48px] leading-[56px] text-primary1 max-sm:text-4xl">Fr</code>om Our Menu</h1>
    <ul className="flex gap-[100px] self-start mt-[56px] max-sm:hidden max-lp:self-center">
    ...
    <div className="mt-[56px] flex gap-[21px] max-sm:mt-10">
     <section>
      <span className="grid grid-cols-1 grid-rows-1 max-sm:hidden">
     ...
     <section className="flex gap-4 max-sm:flex-col max-sm:gap-8">
